...
import com.BFS.BFSweb.entity.User;
import com.BFS.BFSweb.entity.UserRole;
import com.BFS.BFSweb.repository.UserRepository;
...
public class UserService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		com.BFS.BFSweb.entity.User user = userRepository.findByUsername(username);
